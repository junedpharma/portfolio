...
import { Save, Plus, Trash2, ArrowLeft, Building2, Bell, Gift, Users, CheckCircle2, FileText, Image as ImageIcon, Loader2, LogOut, Lock, Mail, KeyRound } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center p-4">
        <div className="flex items-center gap-3 text-emerald-400 font-bold text-sm">
          <Loader2 className="w-6 h-6 animate-spin text-[#059669]" /> Verifying Firebase Authentication...
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-slate-900/90 border border-slate-800 backdrop-blur-xl rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
          ...
          <div className="text-center space-y-2">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#059669] to-[#0d9488] flex items-center justify-center mx-auto text-white shadow-lg shadow-emerald-900/40">
            ...
            <p className="text-xs font-semibold text-slate-400">
              Sign in with Firebase Authentication to manage site content
            </p>
          </div>

          {/* Auth Error Banner */}
          {authError && (
            <div className="bg-rose-950/70 border border-rose-800 text-rose-200 px-4 py-2.5 rounded-xl text-xs font-bold leading-relaxed">
              {authError}
            </div>
          )}
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-300 mb-1 flex items-center gap-1.5">
                <Mail className="w-3.5 h-3.5 text-[#059669]" /> Admin Email
              </label>
              <input
                type="email"
                required
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-2.5 text-sm font-semibold text-white placeholder-slate-500 focus:border-emerald-500 focus:outline-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-[#059669] hover:bg-[#047857] text-white font-black text-sm flex items-center justify-center gap-2 shadow-lg transition-all cursor-pointer disabled:opacity-50"
            >
              {isSubmittingAuth ? (
          ...
          <button
            ...
            disabled={isSubmittingAuth}
            className="w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 font-bold text-xs flex items-center justify-center gap-2 transition-colors cursor-pointer"
          >
          ...
          {/* Toggle Login vs Registration Mode */}
          ...
          <div className="text-center">
            <Link href="/" className="text-xs font-bold text-slate-500 hover:text-slate-300 transition-colors flex items-center justify-center gap-1">
              <ArrowLeft className="w-3.5 h-3.5" /> Return to Live Website
            </Link>
          </div>
